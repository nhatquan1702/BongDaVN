...
public class TranDau {
    ...
    public TranDau(String match_id, String match_happen_time, String match_location, String clb_home_name, String clb_guess_name, String match_result, String match_description) {
    ...
    public String getMatch_happen_time() {
        return match_happen_time;
    }

    public void setMatch_happen_time(String match_happen_time) {
        this.match_happen_time = match_happen_time;
    }
