...
public class DaDuyetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_da_duyet);
        ...
        adapter.setOnItemClickListener(new ItemClickInterface() {
            ...
            public void onClick(View view, int position) {
                Toast.makeText(DaDuyetActivity.this, "Bài viết này đã được phê duyệt!", Toast.LENGTH_SHORT).show();
            }
        });
        mRecyclerView.setAdapter(adapter);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
