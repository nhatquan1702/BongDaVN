...
public class DangChoDuyetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dang_cho_duyet);
        ...
        ItemTouchHelper helper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull @NotNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DangChoDuyetActivity.this);
        ...
        adapter.setOnItemClickListener(new ItemClickInterface() {
            ...
            public void onClick(View view, int position) {
                Toast.makeText(DangChoDuyetActivity.this, "Bài viết này đang chờ phê duyệt!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void LoadFab() {
        ...
        fab3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DangChoDuyetActivity.this, ThemBaiVietChoActivity.class);
        ...
        fab4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(DangChoDuyetActivity.this,(view, year, month, dayOfMonth) ->{
                    ...
                    simpleAPI.getBaiVietByAccountAndDate(mAuthor,strDate).enqueue(new Callback<ArrayList<Post>>() {
                        ...
                        public void onResponse(Call<ArrayList<Post>> call, Response<ArrayList<Post>> response) {
                            ...
                            if(mData.size() == 0)
                                Toast.makeText(DangChoDuyetActivity.this,"không có bài viết nào vào ngày này",Toast.LENGTH_SHORT).show();
        ...
        simpleAPI.deletePost(post_id).enqueue(new Callback<Status>() {
            ...
            public void onResponse(Call<Status> call, Response<Status> response) {
                ...
                if(status.getStatus()==2){
                    Toast.makeText(DangChoDuyetActivity.this, "Xóa bài viết thành công!", Toast.LENGTH_SHORT).show();
                    LoadBaiViet();
                    adapter = new BaiVietAdapter(getApplicationContext(),mData);
                    mRecyclerView.setAdapter(adapter);
                    mRecyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                    ...
                    Toast.makeText(DangChoDuyetActivity.this, "Xóa bài viết không thành công!", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<Status> call, Throwable t) {
                Toast.makeText(DangChoDuyetActivity.this, "Lỗi: "+t.toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
